					...
					<?php foreach($deals as $deal){
						...
						?>
								<tr>
									...
									<td><?php if($deal['db_dealstatus'] == 'pending'){?><button class="btn btn-success btn-sm print-offer" data-dealid="<?=$deal['dd_autoid']?>" data-offerid="<?=$deal['db_offerid']?>" ><i class="fa fa-print"></i></button><?php }?></td>
								</tr>
					<?php } ?>
				</table>
			</div>
