					...
					<?php foreach($deals as $deal){
						...
						?>
								<tr>
									...
									<td><?php if($deal['db_dealstatus'] == 'pending'){?><button class="btn btn-success btn-sm print-offer" data-dealbuyoutid="<?=base64_encode($deal['db_autoid']) ?>"  ><i class="fa fa-print"></i></button><?php }?></td>
								</tr>
					<?php } ?>
				</table>
			</div>
